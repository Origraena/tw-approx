...
\begin{tikzpicture}[]
	...
	\node [vertex,fill=green!50] (v6) [below of=v4] {};
	\node [vertex] (v7) [below right of=v5] {};
	\node [vertex,fill=green!50] (v8) [right of=v4] {};
	\node [vertex,fill=green!50] (v9) [above right of=v4] {};
	\node [vertex,fill=green!50] (v10) [above left of=v9] {};
...
\end{tikzpicture}
\end{center}
\caption{preuve \ref{propdiestel} : construction $A_i \cap X < k$}
\label{fig_aicapx2a}
\end{figure}
